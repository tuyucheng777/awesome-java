...
* [Bot](docs/doc3.md#Bot)
    * [Discord机器人](docs/doc3.md#Discord机器人)
    * [Telegram机器人](docs/doc3.md#Telegram机器人)
    * [Facebook机器人](docs/doc3.md#Facebook机器人)
    * [QQ机器人](docs/doc3.md#QQ机器人)
    * [微信机器人](docs/doc3.md#微信机器人)
* [Android开发](docs/doc3.md#Android开发)
    * [Android框架](docs/doc3.md#Android框架)
    * [Android UI库](docs/doc3.md#Android-UI库)
    ...
    * [Android选择器](docs/doc3.md#Android选择器)
    * [Android图片/视频选择器](docs/doc3.md#Android图片视频选择器)
    * [Android颜色选择器](docs/doc3.md#Android颜色选择器)
    * [Android日期/时间选择器](docs/doc3.md#Android日期时间选择器)
    * [Android文件/目录选择器](docs/doc3.md#Android文件目录选择器)
    * [Android国家选择器](docs/doc3.md#Android国家选择器)
    * [Android城市选择器](docs/doc3.md#Android城市选择器)
    * [Android位置选择器](docs/doc3.md#Android位置选择器)
    * [Android数字选择器](docs/doc3.md#Android数字选择器)
    * [Android滚动选择器](docs/doc3.md#Android滚动选择器)
    * [Android联系人选择器](docs/doc3.md#Android联系人选择器)
    * [Android更新库](docs/doc3.md#Android更新库)
    * [Android热修复](docs/doc3.md#Android热修复)
    * [Android运行时权限](docs/doc3.md#Android运行时权限)
    * [Android下载库](docs/doc3.md#Android下载库)
* [GUI开发/程序](docs/doc3.md#GUI开发程序)
    ...
    * [Swing测试库](docs/doc3.md#Swing测试库)
    * [JavaFX](docs/doc3.md#JavaFX)
    ...
    * [JavaFX程序](docs/doc3.md#JavaFX程序)
    * [GUI程序](docs/doc3.md#GUI程序)
    * [IDE](docs/doc3.md#IDE)
    * [可视化编程](docs/doc3.md#可视化编程)
    * [文本编辑器](docs/doc3.md#文本编辑器)
...
* [编译器](docs/doc3.md#编译器)
    * [内存中编译器](docs/doc3.md#内存中编译器)
    * [AOT编译器](docs/doc3.md#AOT编译器)
    * [编译器插件](docs/doc3.md#编译器插件)
* [AOT编译器](docs/doc3.md#AOT编译器)
...
* [地理空间](docs/doc3.md#地理空间)
    * [坐标库](docs/doc3.md#坐标库)
    * [经纬度库](docs/doc3.md#经纬度库)
    * [GIS系统](docs/doc3.md#GIS系统)
    * [GIS GUI](docs/doc3.md#GIS-GUI)
...
* [注解处理器](docs/doc3.md#注解处理器)
    * [构建器模式](docs/doc3.md#构建器模式)
    * [访问器模式](docs/doc3.md#访问器模式)
    * [不可变模式](docs/doc3.md#不可变模式)
    * [配置对象模式](docs/doc3.md#配置对象模式)
    * [处理器测试](docs/doc3.md#处理器测试)
